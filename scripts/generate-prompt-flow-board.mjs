...
const OUT = "design/curiositypedia-prompt-context-flow";
const E = [];
let n = 0;
let frameId = null;
...
card(90, 1435, 1660, 1460, "A · buildInstructions(performer) + buildResearchInput(prepared)", `“You are the research-performer inside CuriosityPedia, a curiosity product for learners.”
