const messages: Record<string, string> = {
  ...
  "Usage": "الاستخدام",
  "Settings": "الإعدادات",
  "curiosity, performed": "فضول، تم التنفيذ",
  "WonderDrive views": "رؤى WonderDrive",
  ...
  "WonderDrive chooses one": "يختار WonderDrive أحدهما",
  ...
  "Select two saved journeys. WonderDrive compares their committed paths, topics, and performers.": "اختر رحلتين محفوظتين. ستقوم WonderDrive بمقارنة مساراتهما المعتمدة، ومواضيعهما، ومؤدييهما.",
  ...
  "Balanced": "متوازن",
  "Rich": "غني",
  "Separate from how deeply WonderDrive researches.": "منفصل عن مدى عمق بحث WonderDrive.",
  "Text size": "حجم النص",
  "Small": "صغير",
  "Medium": "متوسط",
  "Large": "كبير",
  ...
  "Opening your WonderDrive library…": "جاري فتح مكتبة WonderDrive الخاصة بك...",
  ...
  "WonderDrive — Give curiosity a direction": "WonderDrive — امنح فضولك اتجاهاً",
