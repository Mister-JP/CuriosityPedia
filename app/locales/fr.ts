const messages: Record<string, string> = {
  ...
  "Usage": "Utilisation",
  "Settings": "Paramètres",
  "curiosity, performed": "curiosité, effectué",
  "WonderDrive views": "Vues WonderDrive",
  ...
  "WonderDrive chooses one": "WonderDrive en choisit un",
  ...
  "Select two saved journeys. WonderDrive compares their committed paths, topics, and performers.": "Sélectionnez deux parcours enregistrés. WonderDrive compare leurs chemins validés, sujets et acteurs.",
  ...
  "Balanced": "Équilibré",
  "Rich": "Riche",
  "Separate from how deeply WonderDrive researches.": "Indépendant de la profondeur de recherche de WonderDrive.",
  ...
  "Opening your WonderDrive library…": "Ouverture de votre bibliothèque WonderDrive…",
  ...
  "WonderDrive — Give curiosity a direction": "WonderDrive — Donnez une direction à votre curiosité",
