const messages: Record<string, string> = {
  ...
  "Usage": "ব্যবহার",
  "Settings": "সেটিংস",
  "curiosity, performed": "কৌতূহল, সম্পন্ন হয়েছে",
  "WonderDrive views": "WonderDrive ভিউ",
  ...
  "WonderDrive chooses one": "WonderDrive একটি বেছে নেয়",
  ...
  "Select two saved journeys. WonderDrive compares their committed paths, topics, and performers.": "দুটি সংরক্ষিত যাত্রা নির্বাচন করুন। WonderDrive তাদের সম্পন্ন পথ, বিষয় এবং পারফর্মার তুলনা করে।",
  ...
  "Rich": "সমৃদ্ধ",
  "Separate from how deeply WonderDrive researches.": "WonderDrive কতটা গভীরভাবে গবেষণা করে তার থেকে আলাদা।",
  ...
  "Opening your WonderDrive library…": "আপনার WonderDrive লাইব্রেরি খোলা হচ্ছে…",
  ...
  "WonderDrive — Give curiosity a direction": "WonderDrive — কৌতূহলকে একটি দিক দিন",
